...
app.config["MAX_CONTENT_LENGTH"] = 4*1024*1024 #2MB max-limit


class UploadImage(FlaskForm):
    file = FileField(validators=[FileRequired(), FileAllowed(['jpeg'], 'Images only!')]) #allow only files with the jpg extension to be submitted
...
def upload():
    ...
    if request.method =="POST":
        ...
        if form.validate_on_submit():
            ...
            #load model
            model = tf.keras.models.load_model("attempt3.h5")
            ...
            save_from_arr(image, "static/Model_output/generated_im.jpg")
           ...
           # if len(os.listdir("static/Model_output")) != 0:
            ...
            return render_template(f"index.html", form=form, model_output=model_output)
